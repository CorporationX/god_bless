...
class UserActionAnalyzerTest {
    ...
    @Test
    void topActiveUsers() {
        assertTrue(UserActionAnalyzer.topActiveUsers(getUserActions()).get(0).contains("Bob"));
    }

    @Test
    void topPopularHashtags() {
        assertTrue(UserActionAnalyzer.topPopularHashtags(getUserActions()).get(0).contains("#update"));
    }

    @Test
    void topCommentersLastMonth() {
        assertTrue(UserActionAnalyzer.topCommentersLastMonth(getUserActions()).get(0).contains("Charlie"));
    }

    @Test
    void actionPercentages() {
        assertEquals(23.214285714285715, UserActionAnalyzer.actionPercentages(getUserActions()).get(ActionType.COMMENT));
    }

    private List<UserAction> getUserActions() {
        return Arrays.asList(
                ...
                new UserAction(6, "Dima", ActionType.SHARE, LocalDate.of(2024, 10, 19), ""),
                new UserAction(6, "Dima", ActionType.LIKE, LocalDate.of(2024, 10, 20), ""),
                new UserAction(7, "Vasya", ActionType.SHARE, LocalDate.of(2024, 10, 19), ""),
                new UserAction(8, "Kolya", ActionType.SHARE, LocalDate.of(2024, 10, 19), ""),
                new UserAction(9, "Petya", ActionType.SHARE, LocalDate.of(2024, 10, 19), ""),
                new UserAction(10, "Vlad", ActionType.SHARE, LocalDate.of(2024, 10, 19), ""),
                new UserAction(11, "Denis", ActionType.SHARE, LocalDate.of(2024, 10, 19), "")
        );
    }
}