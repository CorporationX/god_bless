...
class CoordinatesTest {
    ...
    void testSuccessVerticalTransformMatrix() {
        ...
        assertArrayEquals(expectedMatrix3, Coordinates.flipMatrix(matrix3, FlipDirection.VERTICAL));
    }
    ...
    void testSuccessHorizontalTransformMatrix() {
        ...
        assertArrayEquals(expectedMatrix3, Coordinates.flipMatrix(matrix3, FlipDirection.HORIZONTAL));
    }
    ...
    void testFlipMatrixWithInvalidInputParameters() {
        ...
        assertEquals(0, Coordinates.flipMatrix(new int[][]{}, FlipDirection.HORIZONTAL).length);
        assertEquals(0, Coordinates.flipMatrix(new int[][]{{1}, {2}, {3}}, null).length);
    }
}