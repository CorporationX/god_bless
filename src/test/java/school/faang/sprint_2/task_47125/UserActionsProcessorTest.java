...
public class UserActionsProcessorTest {
    List<UserAction> actions = Arrays.asList(
            new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2024, 12, 1), "Check out this amazing #newfeature!"),
            new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2024, 12, 2), "I totally agree with #newfeature."),
            new UserAction(1, "Alice", ActionType.LIKE, LocalDate.of(2024, 12, 3), ""),
            new UserAction(3, "Charlie", ActionType.SHARE, LocalDate.of(2024, 12, 4), ""),
            ...
            new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2024, 12, 20), ""),
            new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2024, 12, 21), "Excited for the upcoming #conference!"),
            new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 12, 22), "I'll be at the #conference too!"),
            ...
            new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2024, 12, 25), "#conference was a blast!"),
            ...
            new UserAction(1, "Alice", ActionType.COMMENT, LocalDate.of(2024, 12, 30), "Excited to try out the new #update!"),
            new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2024, 10, 1), ""),
            new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 12, 2), "The #update has some great features."),
            ...
            new UserAction(4, "Dave", ActionType.COMMENT, LocalDate.of(2024, 12, 14), "#feature works really well."),
