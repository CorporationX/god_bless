package school.faang.sprint_2.task_46037;

import org.junit.jupiter.api.Test;
import school.faang.task_46037.Process;
...
public class ProcessTest {
    ...
    void testSumEmptyList() {
        ...
        assertEquals(0, Process.sum(numbers));
    }
    ...
    void testSumWithZero(){
        List<Integer> numbers = Arrays.asList(1,0,3,4,5);
