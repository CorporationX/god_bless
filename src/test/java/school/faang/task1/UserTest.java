...
public class UserTest {
    ...
    @Test
    public void testSortUsersSingleElement() {
        List<User> users = new ArrayList<>();
        User user = new User("User 1", 20, "Company 1", "Address 111");
        users.add(user);
    ...
    @Test
    public void testSortUsersMultipleUsersDifferentAge() {
        List<User> users = new ArrayList<>();
    ...
    @Test
    public void testSortUsersMultipleUsersSameAge() {
        List<User> users = new ArrayList<>();
        User user1 = new User("User 1", 30, "Company 1", "Address 111");
    ...
    @Test
    public void testSortUsersEmptyList() {
        List<User> users = new ArrayList<>();
        Map<Integer, List<User>> integerListMap = sortUsers(users);
