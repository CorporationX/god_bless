...
class UserActionAnalyzerTest {
    ...
    void setUp() {
        userActions = Arrays.asList(
                ...
                new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2024, 10, 21),
                        "Excited for the upcoming #conference!"),
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 10, 22),
                        "I'll be at the #conference too!"),
                new UserAction(5, "Eve", ActionType.LIKE, LocalDate.of(2024, 10, 23), ""),
                new UserAction(4, "Dave", ActionType.POST, LocalDate.of(2024, 10, 24),
                        "Had a great time at the #conference."),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2024, 10, 25),
                ...
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2024, 10, 28),
                        "The new #update is rolling out today."),
                new UserAction(4, "Dave", ActionType.LIKE, LocalDate.of(2024, 10, 21), ""),
                new UserAction(1, "Alice", ActionType.COMMENT, LocalDate.of(2024, 10, 30),
                        "Excited to try out the new #update!"),
                new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2024, 11, 1), ""),
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 11, 24),
                ...
                new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2024, 11, 5),
                ...
                new UserAction(5, "Eve", ActionType.COMMENT, LocalDate.of(2024, 12, 1),
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 11, 11),
                        "Sharing my thoughts on the #update."),
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2024, 11, 12),
                ...
                new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2024, 11, 15),
                ...
                new UserAction(2, "Bob", ActionType.POST, LocalDate.of(2024, 11, 18),
