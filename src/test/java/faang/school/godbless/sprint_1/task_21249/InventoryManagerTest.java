...
import static faang.school.godbless.sprint_1.task_21249.TestConstants.*;
import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.junit.jupiter.api.Assertions.assertNotEquals;

class InventoryManagerTest {

    private final faang.school.godbless.sprint_1.task_21249.Character frodo
            = new faang.school.godbless.sprint_1.task_21249.Character("Frodo");
    private final faang.school.godbless.sprint_1.task_21249.Character sam = new Character("Sam");
    ...
    private void fillHobbitsInventoryWithInventoryManager() {
        INVENTORY_MANAGER.addItem(frodo, RING,
                (item) -> System.out.println(item.getName() + " was added to the inventory."));

        INVENTORY_MANAGER.addItem(sam, FOOD,
                (item) -> System.out.println(item.getName() + " was added to the inventory."));
        INVENTORY_MANAGER.addItem(sam, WATER,
                (item) -> System.out.println(item.getName() + " was added to the inventory."));
        INVENTORY_MANAGER.addItem(sam, CLOTHES,
                (item) -> System.out.println(item.getName() + " was added to the inventory."));
    }
