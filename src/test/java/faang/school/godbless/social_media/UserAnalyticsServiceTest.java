...
class UserAnalyticsServiceTest {
    ...
    void testGetActionsPercentage() {
        assertEquals(9, UserAnalyticsService.getActionsPercentage(userActions).get("like"));
        assertEquals(9, UserAnalyticsService.getActionsPercentage(userActions).get("share"));
        assertEquals(27, UserAnalyticsService.getActionsPercentage(userActions).get("comment"));
        assertEquals(54, UserAnalyticsService.getActionsPercentage(userActions).get("post"));
    }
}
