...
class InventoryManagerTest {
    private faang.school.godbless.lambda_stream.lord_of_the_rings.Character hobbit;
    ...
    void setUp() {
        ...
        hobbit = new faang.school.godbless.lambda_stream.lord_of_the_rings.Character("Frodo", new ArrayList<>(Arrays.asList(ring, spear)));
    }
