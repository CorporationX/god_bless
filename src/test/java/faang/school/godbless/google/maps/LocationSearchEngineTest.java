...
public class LocationSearchEngineTest {
    ...
    @Test
    public void testLocationSearchEngine() {
        ...
        assertEquals(124.9033, distances.get(0), delta);
        assertEquals(48.1506, distances.get(1), delta);
        assertEquals(238.6735, distances.get(2), delta);
    }
}
