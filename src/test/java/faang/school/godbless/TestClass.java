...
public class TestClass {
    ...
    void testCreateServer() {
        datacenterService.addServer(datacenter,"ABC",new Server(0,10000,3000));
    ...
    void testOptimizationEnergy() {
        datacenterService.addServer(datacenter,"ABC",new Server(0,10000,4000));
        datacenterService.addServer(datacenter,"DEF",new Server(0,8000,3000));
