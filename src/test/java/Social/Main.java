...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Top-10 users: "+ userOperation.topActiveUsers(actions));
        System.out.println("Top-5 topics: "+ userOperation.topPopularTopics(actions));
        System.out.println("User who left more comments: "+ userOperation.userWhoLeftMoreComments(actions));
        System.out.println("Percentage action type: "+ userOperation.сalculatePercentage(actions));
