...
public class Main {
    public static void main(String[] args) {
        ...
        UserActionAnalyzer.topActiveUsers(actions).forEach(action -> System.out.println(action.getName()));
        ...
        for (Map.Entry<String, Double> entry : UserActionAnalyzer.actionTypePercentages(actions).entrySet()) {
