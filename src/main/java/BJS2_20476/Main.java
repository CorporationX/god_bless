...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StreamEvent.addEvent(eventsList, eventsById, eventsByType, new StreamEvent("Cache", DATE_TIME_FORMATTER.format(LocalDateTime.now())));
        StreamEvent.addEvent(eventsList, eventsById, eventsByType, new StreamEvent("Cache", DATE_TIME_FORMATTER.format(LocalDateTime.now())));
        StreamEvent.addEvent(eventsList, eventsById, eventsByType, new StreamEvent("Log", DATE_TIME_FORMATTER.format(LocalDateTime.now())));
        StreamEvent.addEvent(eventsList, eventsById, eventsByType, new StreamEvent("Log", DATE_TIME_FORMATTER.format(LocalDateTime.now())));
        StreamEvent.addEvent(eventsList, eventsById, eventsByType, new StreamEvent("Payment Service", DATE_TIME_FORMATTER.format(LocalDateTime.now())));
        StreamEvent.addEvent(eventsList, eventsById, eventsByType, new StreamEvent("Payment Service", DATE_TIME_FORMATTER.format(LocalDateTime.now())));
