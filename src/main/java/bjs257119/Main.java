...
public class Main {
    ...
    private static void generateTestData() {
        ...
        hogwartsSpells.addSpellEvent("Cemetery Magic", "Establish contact with the Owner of the cemetery");
        hogwartsSpells.addSpellEvent("Cemetery Magic", "Summon the Spirit of the Dead for advice");
        hogwartsSpells.addSpellEvent("Klippotic Magic", "Initiation with Naahema");
        hogwartsSpells.addSpellEvent("Klippotic Magic", "Activate the Sigil of Bairiron");
        hogwartsSpells.addSpellEvent("Klippotic Magic", "Make a request to the Other Party");
        ...
        System.out.printf("Found SpellEvents by type: %s %n", hogwartsSpells.getSpellEventsByType("Klippotic Magic"));
