...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Сумма четных чисел: " + ListOperations.findSumOfEvenNumbers(numbers));
        ...
        System.out.println("Строки, содержащие 'an': " + ListOperations.findStringsContainingSubstring(strings, "an"));
