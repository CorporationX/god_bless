...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("We have locations: " + locations);

        LocationSearchEngine searchEngine = new LocationSearchEngine();
        List<Location> filteredLocations = searchEngine
                .filterLocations(locations, (location) -> location.longitude() > 0);
        System.out.println("After filter: " + filteredLocations);
        ...
        System.out.println("Distance to point from base: " + distances);
    }
}
