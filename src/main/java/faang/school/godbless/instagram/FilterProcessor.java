...
public class FilterProcessor {
    public static void main(String[] args) {
        ...
        Function<Image, Image> function1 = i -> new Image(i.getNameF() + "f1 ",  "применен фильтр");
        Function<Image, Image> function2 = i -> new Image(i.getNameF() + "f2", "Наложено изображение");
        System.out.println(applyFilter(image, function1));
        System.out.println(applyFilter(image,combineFilters(function1, function2)));
    }
