...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Quest quest1 = new Quest("Defeat the Lich King", 10, 9898359359L);
        Quest quest2 = new Quest("Retrieve the Sword of Azeroth", 8, 8538783L);
        ...
        questSystem.shutdownAndAwaitExecutor(5L);
    }
}