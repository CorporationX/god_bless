...
public class Main {
    ...
    public static ArrayList<Student> addStudent(ArrayList<Student> list, Student student){
        list.add(student);
        return list;
    }
    public static ArrayList<Student> deleteStudent(ArrayList<Student> list, String name, String faculty, int course){
    ...
    public static String findStudent(ArrayList<Student> list, String faculty, int course){
        for (Student s : list) {
