...
public class Main {
    public static void main(String[] args) {
        ...
        notificationManager.registerFilter(
                notification -> notification.message.contains("неприемлемый контент"),
                notification -> new Notification(notification.type, notification.message.replace("неприемлемый контент", "***"))
        );
