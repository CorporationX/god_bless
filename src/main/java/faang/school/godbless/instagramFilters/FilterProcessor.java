...
public class FilterProcessor {
    ...
    private Function<Image, Image> combineFilters(Function<Image, Image> firstFilter, Function<Image, Image> secondFilter) {
        return firstFilter.compose(secondFilter);
    }

    private Image applyFilter(Image originalImage, Function<Image, Image> combinedFilter) {
        return combinedFilter.apply(originalImage);
    }
}
