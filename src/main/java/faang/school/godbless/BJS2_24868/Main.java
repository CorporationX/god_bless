...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<Void> future = CompletableFuture.allOf(folowersCounts.stream().map(integer -> twitterSubscriptionSystem.followAccount(twitterAccount)).toArray(CompletableFuture[]::new));
        future.join();
