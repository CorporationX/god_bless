...
public class LocationSearchEngine {
    public List<Location> filterLocations(List<Location> locationList, Predicate<Location> predicate) {
        List<Location> correctLocations = null;

        try {
            correctLocations = locationList.getClass().newInstance();
        ...
        // TODO: 22.06.2023 Добавить Optional, чтобы избежать NullPointerException
