...
public class Main {
    ...
    public Map<KeyFacultyAndYear, List<Student>> addStudentInGroups(List<Student> students) {
    ...
    public void removeStudentFromGroups(List<Student> students, String name, String faculty, int year) {
        for (Student student : students) {
    ...
    public void lookAllStudentsByFaculty(Map<KeyFacultyAndYear, List<Student>> studentsByGroups, String faculty, int year) {
