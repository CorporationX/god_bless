...
public class Application {
    public static void main(String... args) {
        ...
        // Вывод результатов
        System.out.println("Оригинальное изображение: " + originalImage.getName());
        System.out.println("Черно-белый фильтр: " + grayscaleImage.getName());
        System.out.println("Фильтр сепии: " + sepiaImage.getName());
        System.out.println("Фильтр виньетки: " + vignetteImage.getName());
        System.out.println("Комбинированный фильтр: " + combinedImage.getName());
    }
}
