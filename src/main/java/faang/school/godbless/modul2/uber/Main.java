...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Economy fare trip cost: " + economyTripCost);
        System.out.println("Comfort fare trip cost: " + comfortTripCost);
        System.out.println("Premium fare trip cost: " + premiumTripCost);
    }
}
