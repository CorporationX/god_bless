...
public class Main {
    public static void main(String[] args) {
        NotificationManager notificationManager = new EnhancedNotificationManager();

        ((EnhancedNotificationManager) notificationManager).addFilter(notification -> !notification.getMessage().isEmpty());

        ((EnhancedNotificationManager) notificationManager).addModifier(notification ->
                new Notification(notification.getType(), "[Modified] " + notification.getMessage())
        );
