...
public class Main {
    ...
    private static Map<Deanery, List<Student>> groupStudents(List<Student> students) {
        ...
        for (Student student : students) {
            deaneries.computeIfPresent(new Deanery(student.getFaculty(), student.getYear()), (deanery, studentGroups) -> {
