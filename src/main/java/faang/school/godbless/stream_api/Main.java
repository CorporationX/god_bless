...
public class Main {
    public static void main(String[] args) {
        List<UserAction> userActions = Arrays.asList(
                new UserAction(1, "Oleg", "post", "This is a #topic post", LocalDate.now()),
                new UserAction(1, "Oleg", "post", "This is a #topic post", LocalDate.now()),
                new UserAction(1, "Oleg", "post", "This is a #topic post", LocalDate.now()),
                new UserAction(1, "Oleg", "post", "This is a #topic post", LocalDate.now()),
                new UserAction(1, "Oleg", "post", "This is a #topic post", LocalDate.now()),
                new UserAction(3, "Dasha", "post", "Another #topic post", LocalDate.now()),
        ...
        System.out.println(getTopTopics(userActions));

        System.out.println(getTopUser(userActions));

        System.out.println(getProcentAction(userActions));
    }
    ...
    public static List<String> getTopUsersByActivity(List<UserAction> actions) {
        return actions.stream()
                ...
                .limit(10)
                .map(userId -> userId.getKey().toString())
                .toList();
    }
    ...
    public static List<String> getTopUser(List<UserAction> actions){
        return actions.stream()
    ...
    public static Map<String, Long> getProcentAction(List<UserAction> actions){
        return actions.stream()
                .collect(Collectors.groupingBy(UserAction::getActionType, Collectors.counting()))
                .entrySet().stream()
                .collect(Collectors.toMap(Map.Entry::getKey,
                        entry -> ((entry.getValue()*100) / actions.size())));
    }
