...
public class App {
    public static void main(String... args) {
        ...
        notificationManager.registeredFilters(Constants.CHECK_BAD_WORDS, (notificationMessage) -> Arrays.stream(Constants.BAD_WORDS).anyMatch(notificationMessage.toLowerCase()::contains));

        // Регистрация обработчиков оповещений
        notificationManager.registerHandler("email", (notification) -> System.out.println("Send via email: " + notification.getMessage()));
        ...
        Notification smsNotification = new Notification("sms", "Your password was successfully changed");
