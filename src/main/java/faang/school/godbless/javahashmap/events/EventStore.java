...
public class EventStore {
    ...
    public void addOrUpdateEvent(int id, StreamEvent event) {
        if (id != event.getId()) {
    ...
    public Map<Integer, StreamEvent> getAllEventsGroupById() {
    ...
    public Map<String, List<StreamEvent>> getAllEventsGroupByType() {
