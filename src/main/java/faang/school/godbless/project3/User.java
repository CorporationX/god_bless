...
public class User {
    ...
    public User(String name, int age, String placeWork, String address) {
        if (age > MIN_AGE && !name.isBlank() && VALID_JOBS.contains(placeWork) && VALID_ADDRESS.contains(address)) {
            this.age = age;
            this.name = name;
            this.placeWork = placeWork;
            this.address = address;
        } else {
            throw new IllegalArgumentException("The data entered is incorrect. Maybe you are over 18? Try again.");
        }
    }
