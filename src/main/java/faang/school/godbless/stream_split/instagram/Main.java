...
// Создание фильтров
        Function<Image, Image> grayscaleFilter = (image) -> new Image(image.name() + "_grayscale", image.describe() + " Фильтр: черно-белый");
        Function<Image, Image> sepiaFilter = (image) -> new Image(image.name() + "_sepia", image.describe() + " Фильтр: сепия");
