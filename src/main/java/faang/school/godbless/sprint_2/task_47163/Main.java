...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Количество строк, начинающихся на 'a': "
                + ListOperations.countStringsStartingWithCharacter(strings, 'a'));
        ...
        System.out.println("Наименьшее число больше 4: " + ListOperations.findMinGreaterThanNumber(numbers, 4));
