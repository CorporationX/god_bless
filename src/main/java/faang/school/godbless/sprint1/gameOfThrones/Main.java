package faang.school.godbless.sprint1.gameOfThrones;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    addHouse(voronins, new House(voronins, "Люся"));
    removeHouse("Баратеон");
    log.info(String.format("Sigil info about house: %s | %s", voronins, getSigilInfoByHouseName(voronins)));
    printHousesInfo();
  }
