...
public class Main {
    ...
    HashMap<String, List<StreamEvent>> streamEventsByType = new HashMap<>();
    ...
    public void addEvent(int id, String eventType, String data) {
        ...
        if(streamEventsByType.containsKey(streamEvent.getEventType())) {
            ...
            streamEventsByType.put(streamEvent.getEventType(), new ArrayList<>(Arrays.asList(streamEvent)));
        }
    }
    ...
    public void deleteStreamEventById(int id) {
        ...
        streamEventsByType.remove(streamEventById.get(id));
    }
