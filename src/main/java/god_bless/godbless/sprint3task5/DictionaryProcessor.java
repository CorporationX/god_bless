package god_bless.godbless.sprint3task5;
...
public class DictionaryProcessor {
    public void processWord (String word, String translation, BiConsumer<String,String> dictionaryProcessing){
        dictionaryProcessing.accept(word, translation);
    }
