...
public class Main {
    public static void main(String[] args) {
        ...
        Image images = new Image("Summer", "Original Image");
        ...
        Image originalImage = filterProcessor.applyFilter(images, blackWhiteFilter);
        ...
        Image combinedImage = filterProcessor.applyFilter(images, combinedFilter);
