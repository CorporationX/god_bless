...
public class Main {
    public static void main(String[] args) {
        TeamAssignmentStrategy balanced = new BalancedTeamAssignmentStrategy();
        ...
        projectTwo.setRequiredSkills(Set.of("Python", "React", "ASP.NET", "Kafka"));
        ...
        projectManager.removeEmployeeFromProject(1, 7);
        projectManager.getTeamForProject(1);
        projectManager.setAssignmentStrategy(balanced);
    }
}
