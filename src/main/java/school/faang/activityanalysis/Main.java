...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(DataProcessor.getActionRatio(actions));
        System.out.println(DataProcessor.topThreeUsersIsActive(actions));
        System.out.println(DataProcessor.getFivePopularTags(actions));
        System.out.println(DataProcessor.topTenUsers(actions));
    }
}
