...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2025, 1, 1), "Check out this amazing #newfeature!"),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 1, 2), "I totally agree with #newfeature."),
                ...
                new UserAction(4, "Dave", ActionType.POST, LocalDate.of(2025, 1, 5), "#Java is awesome!"),
                new UserAction(2, "Bob", ActionType.LIKE, LocalDate.of(2025, 1, 6), ""),
                new UserAction(3, "Charlie", ActionType.POST, LocalDate.of(2025, 1, 7), "Check out this cool #project"),
                new UserAction(1, "Alice", ActionType.COMMENT, LocalDate.of(2025, 1, 8), "Thanks for sharing #project!"),
                new UserAction(4, "Dave", ActionType.LIKE, LocalDate.of(2025, 1, 9), ""),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 1, 10), "#Java is everywhere."),
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2025, 1, 11), "Loving the new #feature release!"),
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 2, 12), "#Java is indeed awesome."),
                new UserAction(5, "Eve", ActionType.LIKE, LocalDate.of(2025, 2, 13), ""),
                new UserAction(4, "Dave", ActionType.SHARE, LocalDate.of(2025, 2, 14), ""),
                new UserAction(2, "Bob", ActionType.POST, LocalDate.of(2025, 2, 15), "Introducing a new #update to the system."),
                new UserAction(1, "Alice", ActionType.SHARE, LocalDate.of(2025, 2, 16), ""),
                new UserAction(5, "Eve", ActionType.COMMENT, LocalDate.of(2025, 2, 17), "#update looks great!"),
                new UserAction(3, "Charlie", ActionType.LIKE, LocalDate.of(2025, 2, 18), ""),
                new UserAction(4, "Dave", ActionType.COMMENT, LocalDate.of(2025, 2, 19), "Really liking the new #feature."),
                new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2025, 2, 20), ""),
                new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2025, 2, 21), "Excited for the upcoming #conference!"),
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 2, 22), "I'll be at the #conference too!"),
                new UserAction(5, "Eve", ActionType.LIKE, LocalDate.of(2025, 1, 23), ""),
                new UserAction(4, "Dave", ActionType.POST, LocalDate.of(2025, 1, 24), "Had a great time at the #conference."),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 1, 25), "#conference was a blast!"),
                ...
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2025, 1, 28), "The new #update is rolling out today."),
                new UserAction(4, "Dave", ActionType.LIKE, LocalDate.of(2025, 1, 29), ""),
                new UserAction(1, "Alice", ActionType.COMMENT, LocalDate.of(2025, 1, 30), "Excited to try out the new #update!"),
                new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2025, 2, 1), ""),
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 2, 2), "The #update has some great features."),
