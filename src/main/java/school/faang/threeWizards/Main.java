...
public class Main {
    public static void main(String[] args) {
        ...
        CompletableFuture<Void> allTasks = CompletableFuture.allOf(hogwartsTask, beauxbatonsTask).thenRun(() ->
        {
            if (hogwarts.getTotalPoints() > beauxbatons.getTotalPoints()){
                System.out.println(hogwarts.getName() + " wins!\nPoints: " + hogwarts.getTotalPoints());
            } else if (hogwarts.getTotalPoints() < beauxbatons.getTotalPoints()) {
                System.out.println(beauxbatons.getName() + " wins!\nPoints: " + beauxbatons.getTotalPoints());
            }   else {
