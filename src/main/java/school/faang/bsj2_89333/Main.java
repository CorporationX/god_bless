...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Average value = " + StreamApiTrainer.getAverageValue(integersForTask3));
        // 4
        List<String> stringsForSearch = List.of("lala", "kaka", "jaja", "haha", "lolo");
        System.out.println("Count of string = " + StreamApiTrainer.getStringCount(stringsForSearch, 'l'));
        // 5
        List<String> stringsForCheck = List.of("assa", "dasa", "dafa", "gaga", "haha");
        System.out.println("Checked List = " + StreamApiTrainer.getStrings(stringsForCheck, "da"));
        // 6
