...
public class Main {
    public static void main(String[] args) {
        ...
        List<Location> longitudeFiltered = searchEngine.filterLocations(locations, (location) -> location.getLongitude() > 0);
        List<Location> latitudeFiltered = searchEngine.filterLocations(locations, (location) -> location.getLatitude() > 5);

        searchEngine.processLocations(longitudeFiltered, (location) -> System.out.println(location.getName()));
        searchEngine.processLocations(latitudeFiltered, (location) -> System.out.println(location.getName()));
        ...
        System.out.println("Расстояния до заданной точки:");
