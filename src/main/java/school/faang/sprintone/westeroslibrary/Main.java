...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Книга найдена на полке: "
                + lib.findBook("Олимпиада 1984", "Джордж Оруэлл", 1949));

        System.out.println("Новый описк несуществующей книги. Книга найдена на полке: "
                + lib.findBook("1984", "Джордж Оруэлл", 1949));
