...
public class CsvConverter {
    ...
    public static String toCsv(List<List<String>> table) {
        ...
        MatrixJoiner<String> matrixJoiner = (matrix) -> joinMatrix(matrix, vectorJoiner);
        return matrixJoiner.join(table);
    }

    private static String joinMatrix(List<List<String>> matrix, VectorJoiner<String> vectorJoiner) {
        if (matrix == null) {
