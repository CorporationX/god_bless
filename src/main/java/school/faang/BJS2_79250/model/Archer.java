...
public class Archer extends Character {
    private static final int DEFAULT_STRENGTH_ATTRIBUTE_VALUE = 3;
    private static final int DEFAULT_AGILITY_ATTRIBUTE_VALUE = 10;
    private static final int DEFAULT_INTELLIGENCE_ATTRIBUTE_VALUE = 5;
