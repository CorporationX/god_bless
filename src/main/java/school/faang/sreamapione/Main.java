...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Maximum value: " + ListOperations.findMax(numbers));
        System.out.println("Average: " + ListOperations.findAverage(numbers));
        System.out.println("Count of strings starting with 'a': " + ListOperations.countStringsStartingWith(strings, 'a'));
