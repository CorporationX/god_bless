...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> topUsers = UserAction.topActiveUsers(actions);
        List<String> topHashtags = UserAction.topPopularHashtags(actions);
        List<String> topCommenters = UserAction.topCommentersLastMonth(actions);
        Map<String, Double> actionPercentages = UserAction.actionTypePercentages(actions);
