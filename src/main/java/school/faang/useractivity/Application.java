...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("Top-10 activity user: " + UserActionAnalyzer.topActiveUsers(actions));
        System.out.println("Top-5 popular hashtags: " + UserActionAnalyzer.topPopularHashtags(actions));
        System.out.println("Top-3 commenters one month ago: " + UserActionAnalyzer.topCommentersLastMonth(actions));
        System.out.println("Percentages by types: " + UserActionAnalyzer.actionTypePercentages(actions));
