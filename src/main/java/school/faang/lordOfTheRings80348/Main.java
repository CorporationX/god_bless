...
public class Main {
    public static void main(String[] args) {
        ...
        manager.addItem(frodo, ring, (item) -> System.out.printf("Предмет '%s' был добавлен в инвентарь" +
                " персонажа '%s' %n", item.getName(), frodo.getName()));
        ...
        manager.updateItem(frodo, (item) -> item.getName().equals("The Ring"),
