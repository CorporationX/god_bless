package school.faang.java_collection.bjs2_68727.vesteross_library;
...
public class LibrarySystem {
    ...
    public void addBook(String title, String author, int year, String location) {
        this.libraryMap.put(new Book(title, author, year), location);
    }

    public void removeBook(String title, String author, int year) {
        findBook(title, author, year);
        this.libraryMap.remove(new Book(title, author, year));
    }
