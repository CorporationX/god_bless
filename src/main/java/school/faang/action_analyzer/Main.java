...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Вывод результатов
        logger.info("Топ-10 активных пользователей: {}", top10Users);
        logger.info("Топ-5 популярных хэштегов: {}", top5Hashtags);
        logger.info("Топ-3 комментаторов за последний месяц: {}", top3Commenters);
        logger.info("Процент действий по типам: {}", actionPercentages);
    }
    ...
    private static List<UserAction> getUserActions() {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 2, 2),
                ...
                new UserAction(5, "Eve", ActionType.SHARE, LocalDate.of(2025, 2, 17), ""),
                new UserAction(2, "Bob", ActionType.POST, LocalDate.of(2025, 2, 18),
                        "Can't wait for the next #update."),
                new UserAction(4, "Dave", ActionType.SHARE, LocalDate.of(2025, 2, 19), "")
        );
        return actions;
    }
}