...
public class Runner {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025,
                        9, 2), "I totally agree with #newfeature."),
                new UserAction(1, "Alice", ActionType.LIKE, LocalDate.of(2025,
                        9, 3), ""),
                new UserAction(3, "Charlie", ActionType.SHARE, LocalDate.of(2025,
                        9, 4), ""),
                new UserAction(4, "Dave", ActionType.POST, LocalDate.of(2025,
                        9, 5), "#Java is awesome!"),
                new UserAction(2, "Bob", ActionType.LIKE, LocalDate.of(2025,
                        9, 6), ""),
                new UserAction(3, "Charlie", ActionType.POST, LocalDate.of(2025,
                        9, 7), "Check out this cool #project"),
                new UserAction(1, "Alice", ActionType.COMMENT, LocalDate.of(2025,
                        9, 8), "Thanks for sharing #project!"),
                new UserAction(4, "Dave", ActionType.LIKE, LocalDate.of(2025,
                        9, 9), ""),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025,
                        9, 10), "#Java is everywhere."),
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2025,
                ...
                new UserAction(2, "Bob", ActionType.POST, LocalDate.of(2025,
                ...
                new UserAction(4, "Dave", ActionType.COMMENT, LocalDate.of(2025,
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2025,
        ...
        log.info("Топ-3 комментатора: {}", analyser.topCommenters(actions, 3));
        log.info("Процент действий для каждого типа: {}", analyser.calculatePercentagesOfAction(actions));
    }
}
