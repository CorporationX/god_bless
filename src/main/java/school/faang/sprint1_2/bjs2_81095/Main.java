    ...
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                new UserAction(1,
                        ...
                        "C" + "heck out this amazing #newfeature!"),
                new UserAction(2,
                        "Bob",
                        ActionType.COMMENT,
                ...
                new UserAction(3,
                        ...
                        "C" + "heck out this cool #project"),
                new UserAction(1,
                        "Alice",
                        ActionType.COMMENT,
                        LocalDate.of(2024, 9, 8),
                        "T" + "hanks for sharing #project!"),
                new UserAction(4,
                        "Dave",
                        ActionType.LIKE,
                ...
                new UserAction(5,
                        ...
                        "L" + "oving the new #feature release!"),
                new UserAction(3,
                        "Charlie",
                        ActionType.COMMENT,
                ...
                new UserAction(2,
                        ...
                        "I" + "ntroducing a new #update to the system."),
                new UserAction(1,
                        "Alice",
                        ActionType.SHARE,
                ...
                new UserAction(4,
                        ...
                        "R" + "eally liking the new #feature."),
                new UserAction(2,
                        "Bob",
                        ActionType.SHARE,
                ...
                new UserAction(1,
                        ...
                        "E" + "xcited for the upcoming #conference!"),
                new UserAction(3,
                        "Charlie",
                        ActionType.COMMENT,
                ...
                new UserAction(4,
                        ...
                        "H" + "ad a great time at the #conference."),
                new UserAction(2,
                        "Bob",
                        ActionType.COMMENT,
                ...
                new UserAction(5,
                        ...
                        "T" + "he new #update is rolling out today."),
                new UserAction(4,
                        "Dave",
                        ActionType.LIKE,
                ...
                new UserAction(1,
                        ...
                        "E" + "xcited to try out the new #update!"),
                new UserAction(2,
                        "Bob",
                        ActionType.SHARE,
                ...
                new UserAction(3,
                        ...
                        "T" + "he #update has some great features."),
                new UserAction(5,
                        "Eve",
                        ActionType.LIKE,
                ...
                new UserAction(3,
                        ...
                        "H" + "ere's my review of the new #update."),
                new UserAction(5,
                        "Eve",
                        ActionType.COMMENT,
                        LocalDate.of(2024, 10, 8),
                        "Y" + "our #review was helpful!"),
                new UserAction(4,
                        "Dave",
                        ActionType.LIKE,
                ...
                new UserAction(3,
                        ...
                        "S" + "haring my thoughts on the #update."),
                new UserAction(5,
                        "Eve",
                        ActionType.POST,
                        LocalDate.of(2024, 10, 12),
                        "W" + "hat a great #feature this update brings!"),
                new UserAction(2,
                        "Bob",
                        ActionType.LIKE,
                ...
                new UserAction(1,
                        ...
                        "T" + "he #feature saved me a lot of time."),
                new UserAction(3,
                        "Charlie",
                        ActionType.LIKE,
                ...
                new UserAction(2,
                        ...
                        "C" + "an't wait for the next #update."),
                new UserAction(4,
                        "Dave",
                        ActionType.SHARE,
