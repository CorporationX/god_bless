...
public class Main {
    public static void main(String[] args) {
        ...
        notificationManager.registerHandler(NotificationType.EMAIL, notification ->
                System.out.println("here we send email to user with a message: " + notification.getMessage()));
        ...
        Notification smsNotification = new Notification(NotificationType.SMS,
                "Your notification #2 sent by sms");
        Notification pushNotification = new Notification(NotificationType.PUSH,
                "Your notification #3 sent by PUSH");
        Notification notValidEmailNotification = new Notification(NotificationType.EMAIL,
                "Your notification sent by email");
        Notification emptyEmailNotification = new Notification(NotificationType.EMAIL, "");

        notificationManager.registerFilter(NotificationType.EMAIL, notification ->
