...
public class Main {
    public static void main(String[] args) {
        ...
        manager.registerHandler(NotificationType.EMAIL,
                notification -> System.out.printf("Sending EMAIL: %s%n", notification.getMassage()));
        manager.registerHandler(NotificationType.SMS,
                notification -> System.out.printf("Sending SMS: %s%n", notification.getMassage()));
        manager.registerHandler(NotificationType.PUSH,
                notification -> System.out.printf("Sending PUSH: %s%n", notification.getMassage()));
