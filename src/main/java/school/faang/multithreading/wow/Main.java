...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<Player> player3quest3_5 = questSystem.startQuest(player3, quest3)
        ...
        player2quest2.thenAccept(player -> System.out.println(
                player.getName() + " has completed the quest and now has " + player.getExperience() + " experience points."));
        player3quest3_5.thenAccept(player -> System.out.println(
                player.getName() + " has completed the quest and now has " + player.getExperience() + " experience points."));
        player4quest4.thenAccept(player -> System.out.println(
                player.getName() + " has completed the quest and now has " + player.getExperience() + " experience points."));
    }

    // уточните пожалуйста, нужно ли каким-то образом закрывать потоки, после того как они отработали,
    // чтобы программа не работала до бесконечности?
}
