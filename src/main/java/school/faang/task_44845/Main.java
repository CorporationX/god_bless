...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(
                "2nd fetch (from cache): " + standardData2.getHumidity() + " " + standardData2.getTemperature());
        ...
        System.out.println(
                "3rd fetch (fresh data):" + standardData3.getHumidity() + " " + standardData3.getTemperature());
        ...
        System.out.println(
                "2nd fetch (always fresh): " + frequentData2.getHumidity() + " " + frequentData2.getTemperature());
    }
