...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 9, 7), "Check out this cool #project"),
                new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2024, 9, 8), "Thanks for sharing #project!"),
                ...
                new UserAction(5, "Eve", ActionType.SHARE, LocalDate.of(2024, 9, 11), "Loving the new #feature release!"),
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 9, 12), "#Java is indeed awesome."),
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2024, 9, 13), ""),
                new UserAction(4, "Dave", ActionType.SHARE, LocalDate.of(2024, 9, 14), ""),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2024, 9, 15), "Introducing a new #update to the system."),
                new UserAction(1, "Alice", ActionType.LIKE, LocalDate.of(2024, 9, 16), ""),
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2024, 9, 17), "#update looks great!"),
                new UserAction(3, "Charlie", ActionType.LIKE, LocalDate.of(2024, 9, 18), ""),
                new UserAction(4, "Dave", ActionType.POST, LocalDate.of(2024, 9, 19), "Really liking the new #feature."),
                new UserAction(2, "Bob", ActionType.LIKE, LocalDate.of(2024, 9, 20), ""),
                ...
                new UserAction(1, "Alice", ActionType.COMMENT, LocalDate.of(2024, 10, 5), "Loving the new #update so far."),
