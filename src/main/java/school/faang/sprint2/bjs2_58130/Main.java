package school.faang.sprint2.bjs2_58130;
...
public class Main {
    ...
    public static final int FIVE_USERS = 5;
    public static final int THREE_USERS = 3;

    public static void main(String[] args) {
        List<String> top10Users = UserActionAnalyzer.getTopActiveUsers(ACTIONS, TEN_USERS);
        List<String> top5Hashtags = UserActionAnalyzer.getTopHashtags(ACTIONS, FIVE_USERS);
        List<String> top3Commenters = UserActionAnalyzer.getTopCommentersLastMonth(ACTIONS, THREE_USERS);
        Map<String, Double> actionPercentages = UserActionAnalyzer.getActionTypePercentages(ACTIONS);

        System.out.printf("Топ-10 активных пользователей: %s", top10Users);
        System.out.println();
        System.out.printf("Топ-5 популярных хэштегов: %s", top5Hashtags);
        System.out.println();
        System.out.printf("Топ-3 комментаторов за последний месяц: %s", top3Commenters);
        System.out.println();
        System.out.printf("Процент действий по типам: %s", actionPercentages);
        System.out.println();
    }
}
