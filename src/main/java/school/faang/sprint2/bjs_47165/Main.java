...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = userData();
        ...
        log.info("Топ-5 комментаторов за последний месяц: {}", UserActionAnalyzer.topCommentersLastMonth(actions, 5));
        log.info("Процент действий по типам: {}", UserActionAnalyzer.actionTypePercentages(actions));
    }

    private static List<UserAction> userData() {
