...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = userActionData();
    ...
    private static List<UserAction> userActionData() {
        return Arrays.asList(
                ...
                new UserAction(2, "Bob", "post", LocalDate.of(2024, 11, 15), "Introducing a new #update to the system."),
                ...
                new UserAction(1, "Alice", "comment", LocalDate.of(2024, 11, 30), "Excited to try out the new #update!"),
