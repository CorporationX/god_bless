...
public class Main {
    ...
    private static List<UserAction> getUserActions() {
        return Arrays.asList(
                ...
                new UserAction(6, "Alex", ActionType.SHARE,
                        LocalDate.of(2024, 1, 10), ""),
                new UserAction(7, "Mary", ActionType.SHARE,
                        LocalDate.of(2024, 2, 9), ""),
                new UserAction(8, "Duck", ActionType.SHARE,
                        LocalDate.of(2024, 3, 8), ""),
                new UserAction(9, "John", ActionType.SHARE,
                        LocalDate.of(2024, 4, 7), ""),
                new UserAction(10, "Susan", ActionType.SHARE,
                        LocalDate.of(2024, 5, 6), ""),
                new UserAction(11, "Michael", ActionType.SHARE,
                        LocalDate.of(2024, 6, 5), ""),
                new UserAction(12, "Michelle", ActionType.SHARE,
