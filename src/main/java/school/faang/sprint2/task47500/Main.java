package school.faang.sprint2.task47500;

import school.faang.sprint2.task47500.model.UserAction;
import school.faang.sprint2.task47500.service.UserActionAnalyzer;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Топ-3 комментаторов за последний год: " + topCommenters);
    ...
    private static List<UserAction> getUserActions() {
        return Arrays.asList(
                ...
                new UserAction(6, "Alex", "share",
                        LocalDate.of(2024, 1, 10), ""),
                new UserAction(7, "Mary", "share",
                        LocalDate.of(2024, 2, 9), ""),
                new UserAction(8, "Duck", "share",
                        LocalDate.of(2024, 3, 8), ""),
                new UserAction(9, "John", "share",
                        LocalDate.of(2024, 4, 7), ""),
                new UserAction(10, "Susan", "share",
                        LocalDate.of(2024, 5, 6), ""),
                new UserAction(11, "Michael", "share",
                        LocalDate.of(2024, 6, 5), ""),
                new UserAction(12, "Michelle", "share",
