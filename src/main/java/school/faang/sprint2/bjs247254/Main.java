...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Кол-во строк начинающихся на 'd' — "
                + ListOperations.findCountOfRowsStartingWith(strings, 'd'));
        ...
        System.out.println("Все ли числа четные? — "
                + ListOperations.allMatchCondition(numbers, number -> number % 2 == 0));
        System.out.println("Минимальное число, большее 10 — "
                + ListOperations.findMinGreaterThan(numbers, 10));
