package school.faang.streamapi2.main;

import school.faang.streamapi2.maincode.ListOperations;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Сумма четных чисел: " + ListOperations.getEvenSum(numbers));
