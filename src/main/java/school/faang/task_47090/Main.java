...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(3, "Charlie", "comment", LocalDate.of(2024, 10, 2), "The #update has some great."),
                ...
                new UserAction(3, "Charlie", "comment", LocalDate.of(2024, 10, 11), "Sharing my thoughts on"),
                new UserAction(5, "Eve", "post", LocalDate.of(2024, 10, 12), "What a great #feature this update"),
        ...
        List<Integer> topUsers = UserActionAnalyzer.topActiveUsers(actions);
        ...
        List<Integer> topCommenters = UserActionAnalyzer.topCommentersLastMonth(actions);
