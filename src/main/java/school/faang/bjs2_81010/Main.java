...
public class Main {
    ...
    private static List<UserAction> actions = Arrays.asList(
            new UserAction(
                    1, "Alice", ActionType.POST, LocalDate.of(2025, 5, 1), "Check out this amazing #newfeature!"),
            ...
            new UserAction(
                    2, "Bob", ActionType.POST, LocalDate.of(2025, 5, 15), "Introducing a new #update to the system."),
            ...
            new UserAction(
                    1, "Alice", ActionType.POST, LocalDate.of(2025, 5, 21), "Excited for the upcoming #conference!"),
            new UserAction(
                    3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 5, 22), "I'll be at the #conference too!"),
            new UserAction(5, "Eve", ActionType.LIKE, LocalDate.of(2025, 5, 23), ""),
            new UserAction(
                    4, "Dave", ActionType.POST, LocalDate.of(2025, 5, 24), "Had a great time at the #conference."),
            ...
            new UserAction(
                    5, "Eve", ActionType.POST, LocalDate.of(2025, 5, 28), "The new #update is rolling out today."),
            new UserAction(4, "Dave", ActionType.LIKE, LocalDate.of(2025, 5, 29), ""),
            new UserAction(
                    1, "Alice", ActionType.COMMENT, LocalDate.of(2025, 5, 30), "Excited to try out the new #update!"),
            new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2025, 6, 1), ""),
            new UserAction(
                    3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 6, 2), "The #update has some great features."),
            ...
            new UserAction(
                    3, "Charlie", ActionType.POST, LocalDate.of(2025, 6, 7), "Here's my review of the new #update."),
            ...
            new UserAction(
                    3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 6, 11), "Sharing my thoughts on the #update."),
            new UserAction(
                    5, "Eve", ActionType.POST, LocalDate.of(2025, 6, 12), "What a great #feature this update brings!"),
            ...
            new UserAction(
                    1, "Alice", ActionType.POST, LocalDate.of(2025, 6, 15), "The #feature saved me a lot of time."),
    ...
    public static void main(String[] args) {
        ...
        log.info("Топ-{} активных пользователей: ", LIMIT);
        UserActionAnalyzer.topActiveUsers(actions, LIMIT).forEach(user -> log.info(user.getName()));

        log.info("Топ-{} популярных хэштегов: ", LIMIT);
        UserActionAnalyzer.topPopularHashtags(actions, LIMIT).forEach(log::info);

        log.info("Топ-{} комментаторов за последний месяц: ", LIMIT);
        UserActionAnalyzer.topCommentersLastMonth(actions, LIMIT).forEach(user -> log.info(user.getName()));

        log.info("Процент действий по типам: ");
        UserActionAnalyzer.actionTypePercentages(actions).forEach((key, value) -> log.info("{} : {}", key, value));
    }
}
