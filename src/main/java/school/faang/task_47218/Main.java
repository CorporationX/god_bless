...
public class Main {
    public static <Map> void main(String[] args) {
        ...
        var topUsers = UserActionAnalyzer.topActiveUsers(actions);
        var topHashtags = UserActionAnalyzer.topPopularHashtags(actions);
        var topCommenters = UserActionAnalyzer.topCommentersLastMonth(actions);
