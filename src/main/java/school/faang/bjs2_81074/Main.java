...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> top10Users = UserActionOperations.topActiveUsers(actions, 10);
        List<String> top5Hashtags = UserActionOperations.topHashtags(actions, 5);
        List<String> top3Commenters = UserActionOperations.topCommentUsers(actions, 3);
        Map<ActionType, Double> actionPercentages = UserActionOperations.actionPercentages(actions);
