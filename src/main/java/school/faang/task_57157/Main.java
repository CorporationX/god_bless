...
public class Main {
    public static void main(String[] args) {
        ...
        final Student studentAlex = new Student("Alex");
        final Student studentOlga = new Student("Olga");
        final Student studentOleg = new Student("Oleg");
        ...
        final Subject it = new Subject("it");

        final Map<Subject, Integer> subjectAlex = new HashMap<>();
        final Map<Subject, Integer> subjectOlga = new HashMap<>();
        final Map<Subject, Integer> subjectOleg = new HashMap<>();
        ...
        studentDatabase.addStudentWithGrades(studentOlga, subjectOlga);
        studentDatabase.addStudentWithGrades(studentOleg, subjectOleg);
