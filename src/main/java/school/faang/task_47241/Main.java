...
public class Main {
	...
	public static void main(String[] args) throws JsonProcessingException {
		...
		List<String> strings_Two = Arrays.asList("apple", "banana", "cherry", "date", "fig", "grape");
		...
		System.out.println(SteamApi2Testing.filterAlphabeticallySortLength(strings_Two,alphabet));
	}
}
