package school.faang.analisisuseractivity.main;

import school.faang.analisisuseractivity.maincode.UserAction;
import school.faang.analisisuseractivity.maincode.UserActionAnalyzer;
...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(1, "Vlad", "post", LocalDate.of(2024, 10, 5), "Loving the new #update so far."),
                new UserAction(2, "Gadzhi", "like", LocalDate.of(2024, 10, 6), ""),
                new UserAction(3, "Gadzhi", "post", LocalDate.of(2024, 10, 7), "Here's my review of the new #update."),
                new UserAction(5, "Sveta", "comment", LocalDate.of(2024, 10, 8), "Your #review was helpful!"),
                new UserAction(4, "Sveta", "like", LocalDate.of(2024, 10, 9), ""),
                new UserAction(1, "Inna", "share", LocalDate.of(2024, 10, 10), ""),
                new UserAction(3, "Inna", "comment", LocalDate.of(2024, 10, 11), "Sharing my thoughts on the #update."),
                new UserAction(5, "Andrey", "post", LocalDate.of(2024, 10, 12), "What a great #feature this update brings!"),
                new UserAction(2, "Max", "like", LocalDate.of(2024, 10, 13), ""),
                new UserAction(4, "Max", "comment", LocalDate.of(2024, 10, 14), "#feature works really well."),
                ...
                new UserAction(2, "Andrey", "post", LocalDate.of(2024, 10, 18), "Can't wait for the next #update."),
                new UserAction(4, "Dave", "share", LocalDate.of(2024, 10, 19), "")
        );

        List<String> topUsers = UserActionAnalyzer.getTop10ActiveUsers(actions);
        List<String> topHashtags = UserActionAnalyzer.getTop5PopularDiscussionTopics(actions);
        List<String> topCommenters = UserActionAnalyzer.gettop3CommentatorsLastMonth(actions);
        Map<String, Double> actionPercentages = UserActionAnalyzer.calculateActionPercentages(actions);
