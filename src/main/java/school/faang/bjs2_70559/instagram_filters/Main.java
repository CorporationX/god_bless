package school.faang.bjs2_70559.instagram_filters;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            Function<Image, Image> combinedSecondFilter = filterProcessor.combineFilters(grayscaleFilter, null);
            Image combinedSecondImage = filterProcessor.applyFilter(originalImage, combinedSecondFilter);
            log.info(combinedSecondImage.getDescription());
