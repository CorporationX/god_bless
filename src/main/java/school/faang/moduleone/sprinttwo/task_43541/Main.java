...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = createUserActionsSourceList();
    ...
    private static List<UserAction> createUserActionsSourceList() {
        return Arrays.asList(
                ...
                new UserAction(
                        2, "Bob", "post", LocalDate.of(2024, 11, 15), "Introducing a new #update to the system."),
                ...
                new UserAction(
                        1, "Alice", "comment", LocalDate.of(2024, 11, 30), "Excited to try out the new #update!"),
                new UserAction(2, "Bob", "share", LocalDate.of(2024, 12, 1), ""),
                new UserAction(
                        3, "Charlie", "comment", LocalDate.of(2024, 12, 2), "The #update has some great features."),
                ...
                new UserAction(
                        3, "Charlie", "comment", LocalDate.of(2024, 12, 11), "Sharing my thoughts on the #update."),
                new UserAction(
                        5, "Eve", "post", LocalDate.of(2024, 12, 12), "What a great #feature this update brings!"),
