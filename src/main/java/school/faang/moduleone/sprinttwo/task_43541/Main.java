...
public class Main {
    ...
    private static List<UserAction> createUserActionsSourceList() {
        return Arrays.asList(
                ...
                new UserAction(
                        3, "Charlie", "comment", LocalDate.of(2024, 10, 2), "The #update has some great features."),
                ...
                new UserAction(
                        3, "Charlie", "comment", LocalDate.of(2024, 10, 11), "Sharing my thoughts on the #update."),
                new UserAction(
                        5, "Eve", "post", LocalDate.of(2024, 10, 12), "What a great #feature this update brings!"),
