    ...
    public static void main(String[] args) {
        ...
        allTasks.thenRun(() -> {
            ...
            if (hogwartsPoints > beauxbatonsPoints) {
                System.out.printf("Hogwarts winner. Points: %s%n", hogwartsPoints);
            } else if (hogwartsPoints < beauxbatonsPoints) {
                System.out.printf("Beauxbatons winner. Points: %s%n", beauxbatonsPoints);
            } else {
                System.out.printf("Draw! Both schools scored: %s%n", hogwartsPoints);
            }
        });
    }
}
