...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> strings = Arrays.asList("apple", "banana", "cherry", "date", "anna");

        System.out.println("Сумма четных чисел: " + ListOperations.sumOfEvenNumbers(numbers));
        System.out.println("Максимум: " + ListOperations.findMaximum(numbers));
        System.out.println("Среднее: " + ListOperations.findAverage(numbers));
        System.out.println("Количество строк, начинающихся на 'a': " + ListOperations.countStringsStartWitch(strings, 'a'));
