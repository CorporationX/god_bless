...
public class Main {
    public static void main(String[] args) {
        ...
        Function<Image, Image> fullFilter = filterProcessor
                .combineFilters(combinedFilter, vignetteFilter);

        Image fullyFilteredImage = filterProcessor.applyFilter(originalImage, fullFilter);
        System.out.println(fullyFilteredImage.getDescription());
    }
}