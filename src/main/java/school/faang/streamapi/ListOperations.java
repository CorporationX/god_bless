...
public class ListOperations {
    ...
    public static long countStringsStartingWith(List<String> strings, char startingLetter) {
    ...
    public static int findMinGreaterThan(List<Integer> numbers, int number) {
        return numbers.stream()
                ...
                .min(Integer::compare)
                .orElseThrow(() -> new IllegalArgumentException("Нет элемента больше " + number));
    }
