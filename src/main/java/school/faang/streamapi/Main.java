...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> strings = Arrays.asList("apple", "banana", "cherry", "date", "anything else");
        ...
        System.out.println("Все ли числа больше нуля? " + ListOperations.allMatchCondition(numbers, n -> n > 0));
