...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<String> top10Users = UserService.topActiveUsers(actions, 10);
        System.out.println(top10Users);

        List<String> top5Hashtags = UserService.topPopularDiscussionTopics(actions, 5);
        System.out.println(top5Hashtags);

        List<String> top2Users = UserService.topCommentsLastMonth(actions, 3);
        System.out.println(top2Users);

        System.out.println(UserService.calculatePercentageEachType(actions));
    }
}
