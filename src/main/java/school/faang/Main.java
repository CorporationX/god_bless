...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> topUsers = UserAction.top10ActiveUsers(actions);
        List<String> topHashtags = UserAction.top5content(actions);
        List<String> topCommenters = UserAction.top3Users(actions);
        Map<String, Double> actionPercentages = UserAction.calculateActiveActions(actions);
