...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Строки, содержащие 'an': " + ListOperations.stringsContainingSubstring(strings, "an"));
        ...
        System.out.println("Длины строк: " + ListOperations.getStringsLengths(strings));
    }
}
