...
public class DataInitializer {
    public static List<UserAction> initData() {
        return Arrays.asList(
                ...
                new UserAction(4, "Dave", SHARE,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(6, "Kate", POST,
                        LocalDate.of(2024, 10, 19), "Post from Kate"),
                new UserAction(6, "Kate", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(6, "Kate", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(7, "Alex", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(7, "Alex", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(8, "Mathew", LIKE,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(8, "Mathew", LIKE,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(9, "Maria", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(9, "Maria", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(9, "Maria", LIKE,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(9, "Maria", POST,
                        LocalDate.of(2024, 10, 19), "Post From Maria!!!"),
                new UserAction(10, "Emin", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(10, "Emin", LIKE,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(10, "Emin", LIKE,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(10, "Emin", LIKE,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(11, "Marina", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(11, "Marina", COMMENT,
                        LocalDate.of(2024, 10, 19), ""),
                new UserAction(11, "Marina", COMMENT,
