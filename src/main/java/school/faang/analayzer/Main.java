    ...
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2024, 10, 1),
                        ""),
                new UserAction(3, "Dave", ActionType.COMMENT, LocalDate.of(2024, 10, 2),
                ...
                new UserAction(2, "Bob", ActionType.LIKE, LocalDate.of(2024, 10, 6),
                        ""),
                new UserAction(3, "Bob", ActionType.POST, LocalDate.of(2024, 10, 7),
                ...
                new UserAction(4, "Dave", ActionType.SHARE, LocalDate.of(2024, 10, 19),
                        ""),
                new UserAction(5, "Dave", ActionType.COMMENT, LocalDate.of(2024, 10, 3),
                        "HI!!!")
        );
