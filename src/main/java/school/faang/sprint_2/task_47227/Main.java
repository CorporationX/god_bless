...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 10, 2), "The #update some great features."),
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 10, 11), "Sharing my thoughts on #update"),
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2024, 10, 12), "What great #feature this update brings!"),
        ...
        Map<ActionType, Long> actionPercentages = UserActionAnalyzer.actionTypePercentages(actions);
