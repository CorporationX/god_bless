...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Number of lines starting with 'b': %d\n",
                ListOperations.countStringsStartingWith(strings, 'b'));
        System.out.printf("Lines containing 'an': %s\n",
                ListOperations.filterStringsContainingSubstring(strings, "na"));
        System.out.println("Sorted by string length: " + ListOperations.sortByLength(strings));
        System.out.println("Are all numbers odd? " + ListOperations.allMatchCondition(numbers, n -> n % 3 == 0));
