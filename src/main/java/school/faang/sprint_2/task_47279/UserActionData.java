...
public class UserActionData {
    ...
    public static List<UserAction> getData() {
        return Arrays.asList(
                new UserAction(1, "Alice", "post",
                        LocalDate.of(2024, 11, 1), "Check out this amazing #newfeature!"),
                ...
                new UserAction(4, "Dave", "post",
                        LocalDate.of(2024, 11, 24), "Had a great time at the #conference."),
                new UserAction(2, "Bob", "comment",
                ...
                new UserAction(5, "Eve", "post",
                        LocalDate.of(2024, 11, 28), "The new #update is rolling out today."),
                new UserAction(4, "Dave", "like",
                ...
                new UserAction(1, "Alice", "post",
                        LocalDate.of(2024, 12, 15), "The #feature saved me a lot of time."),
                new UserAction(3, "Charlie", "like",
