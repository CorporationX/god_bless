...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Максимум: " + ListOperations.max(numbers));
        System.out.println("Среднее: " + ListOperations.average(numbers));
        System.out.println("Количество строк, начинающихся на 'a': " + ListOperations.countStringsStartingWith(strings, 'a'));
        System.out.println("Строки, содержащие 'an': " + ListOperations.filterStringContainingSubstring(strings, "an"));
