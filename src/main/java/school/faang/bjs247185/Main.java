...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> topUsers = actionAnalyzer.topActiveUsers(actions);
        List<String> topHashtags = actionAnalyzer.topPopularHashtags(actions);
        List<String> topCommenters = actionAnalyzer.topCommentersLastMonth(actions);
        Map<String, Double> actionPercentages = actionAnalyzer.actionTypePercentages(actions);
