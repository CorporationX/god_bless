...
public class Main {
    public static void main(String[] args) {
        ...
        double economTripCost = fareCalculator.calculateFare(distance, time, economyFare);
        ...
        System.out.println("Тариф Econom: " + economTripCost);
        System.out.println("Тариф Comfort: " + comfortTripCost);
        System.out.println("Тариф Premium: " + premiumTripCost);
    }
}
