...
public class Main {
    public static void main(String[] args) {
        ...
        hogwartsSpells.addSpellEvent(new SpellEvent(2, SpellType.TRANSFIGURATION, "Transforms an object into another object"));
        hogwartsSpells.addSpellEvent(new SpellEvent(3, SpellType.PROTECTION, "Creates a magical shield against attacks"));
