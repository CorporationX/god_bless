...
public class Main {
    public static void main(String[] args) {
        ...
        SpellEvent wandLightingSpell = new SpellEvent(1, SpellType.CHARM,
                "Lights up the tip of the wand");
        SpellEvent objectTransformationSpell = new SpellEvent(2, SpellType.TRANSFIGURATION,
                "Transforms an object into another object");
        SpellEvent magicalShieldSpell = new SpellEvent(3, SpellType.PROTECTION,
                "Creates a magical shield against attacks");
        SpellEvent itemSummonSpell = new SpellEvent(4, SpellType.CHARM,
                "Summons an item to the caster");
        SpellEvent animalToObjectSpell = new SpellEvent(5, SpellType.TRANSFIGURATION,
                "Turns an animal into an object");
        SpellEvent spellNeutralizationSpell = new SpellEvent(6, SpellType.PROTECTION,
                "Neutralizes an opponent's spells");
        SpellEvent voiceAmplificationSpell = new SpellEvent(7, SpellType.CHARM,
                "Increases the volume of the voice");
        SpellEvent objectDuplicationSpell = new SpellEvent(8, SpellType.TRANSFIGURATION,
