...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(StreamHandler.getCapitals(Map.of("Russia", "Moscow", "USA", "Washington", "Germany", "Berlin")));
        ...
        System.out.println(StreamHandler.filterAndSort(List.of("apple", "banana", "cherry", "date", "fig", "grape"), "abcdefghijklmnopqrstuvwxyz"));
    }
}
