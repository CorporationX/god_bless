...
import school.faang.sprint3.squad.warrior.Archer;
import school.faang.sprint3.squad.warrior.Mage;
import school.faang.sprint3.squad.warrior.Swordsman;
...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.printf("Общая сила армии: %d", totalPower);
    }
}
