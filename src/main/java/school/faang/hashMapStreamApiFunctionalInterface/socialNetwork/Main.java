package school.faang.hashMapStreamApiFunctionalInterface.socialNetwork;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<String> topUsers = UserActionAnalyzer.getTopTenActiveUsers(actions);
        List<String> topHashtags = UserActionAnalyzer.getTopFivePopularTopics(actions);
        List<String> topCommenters = UserActionAnalyzer.getTopThreeCommentatorsLastMonth(actions);
        Map<String, Double> actionPercentages = UserActionAnalyzer.getPercentageOfActions(actions);

        System.out.println(topUsers);
        System.out.println(topHashtags);
        System.out.println(topCommenters);
