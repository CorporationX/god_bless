package school.faang.hashMapStreamApiFunctionalInterface.collection;

import java.util.Arrays;
import java.util.List;
import java.util.Set;

import static school.faang.hashMapStreamApiFunctionalInterface.collection.User.findHobbyLovers;
