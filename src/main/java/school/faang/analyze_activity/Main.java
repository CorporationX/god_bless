...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 4, 2),
                        "I totally agree with #newfeature."),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 4, 2),
                        "I totally agree with #newfeature."),
                new UserAction(1, "Alice", ActionType.LIKE, LocalDate.of(2024, 9, 3),
                        ""),
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 4, 10),
                        "#Java is everywhere."),
                new UserAction(3, "Charlie", ActionType.POST, LocalDate.of(2024, 9, 7),
                        "Check out this cool #project"),
                new UserAction(1, "Alice", ActionType.COMMENT, LocalDate.of(2025, 4, 8),
