...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> topUsers = UsersActivityManager.topActiveUsers(actions);
        List<String> topHashtags = UsersActivityManager.topPopularHashtags(actions);
        List<String> topCommenters = UsersActivityManager.topCommentersLastMonth(actions);
        Map<UserAction.ActionType, Double> actionPercentages = UsersActivityManager.actionTypePercentages(actions);
