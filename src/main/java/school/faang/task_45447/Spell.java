...
public class Spell {
    ...
    static {
        ...
        spells.put("Fireball", "Launches a fiery ball that explodes on impact, dealing damage to enemies");
        ...
        spells.put("Arcane Shield", "Surrounds the caster with a protective shield that absorbs a certain amount.");
        ...
        spells.put("Shield of Light", "Creates a radiant barrier that reflects a portion of incoming damage back");
        spells.put("Earthquake", "Causes the ground to tremble violently, damaging and knocking down enemies");
        spells.put("Wind Blast", "Unleashes a powerful gust of wind, pushing enemies away and clearing obstacles.");
        spells.put("Shadow Step", "Allows the caster to move instantly to a shadowy location, avoiding obstacles.");
        ...
        spells.put("Phoenix Flame", "Summons the fiery power of a phoenix, burning enemies and healing allies nearby.");
