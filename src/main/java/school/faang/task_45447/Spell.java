...
public class Spell {
    ...
    static {
        ...
        spells.put("Shield of Light", "Creates a radiant barrier that reflects a portion of incoming damage back to attackers.");
        spells.put("Earthquake", "Causes the ground to tremble violently, damaging and knocking down enemies in the area.");
        spells.put("Wind Blast", "Unleashes a powerful gust of wind, pushing enemies away and clearing obstacles.");
        spells.put("Shadow Step", "Allows the caster to move instantly to a shadowy location, avoiding obstacles and enemies.");
