...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Топ-10 активных пользователей: " + userActionStatistics.getTopActiveUsers(actions, 3));
        System.out.println("Топ-5 популярных хэштегов: " + userActionStatistics.getTopPopularTheme(actions, 5));
        System.out.println("Топ-3 комментаторов за последний месяц: " +
                userActionStatistics.getTopActiveUsersWithComment(actions, 3));
        System.out.println("Процент действий по типам: " + userActionStatistics.getPercentageOfActionType(actions));
    }
}
