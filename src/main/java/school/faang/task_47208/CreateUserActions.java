...
public class CreateUserActions {
    public static List<UserAction> createListUserActions() {
        return Arrays.asList(
                new UserAction(1, "Alice", EnumActionType.POST,
                        LocalDate.of(2024, 9, 1),
                        "Check out this amazing #newfeature!"),
                new UserAction(2, "Bob", EnumActionType.COMMENT,
                        LocalDate.of(2024, 9, 2),
                        "I totally agree with #newfeature."),
                new UserAction(1, "Alice", EnumActionType.LIKE,
                        LocalDate.of(2024, 9, 3),
                        ""),
                new UserAction(3, "Charlie", EnumActionType.SHARE,
                        LocalDate.of(2024, 9, 4),
                        ""),
                new UserAction(4, "Dave", EnumActionType.POST,
                        LocalDate.of(2024, 9, 5),
                        "#Java is awesome!"),
                new UserAction(2, "Bob", EnumActionType.LIKE,
                        LocalDate.of(2024, 9, 6),
                        ""),
                new UserAction(3, "Charlie", EnumActionType.POST,
                        LocalDate.of(2024, 9, 7),
                        "Check out this cool #project"),
                new UserAction(1, "Alice", EnumActionType.COMMENT,
                        LocalDate.of(2024, 9, 8),
                        "Thanks for sharing #project!"),
                new UserAction(4, "Dave", EnumActionType.LIKE,
                        LocalDate.of(2024, 9, 9),
                        ""),
                new UserAction(2, "Bob", EnumActionType.COMMENT,
                        LocalDate.of(2024, 9, 10),
                        "#Java is everywhere."),
                new UserAction(5, "Eve", EnumActionType.POST,
                        LocalDate.of(2024, 9, 11),
                        "Loving the new #feature release!"),
                new UserAction(3, "Charlie", EnumActionType.COMMENT,
                        LocalDate.of(2024, 9, 12),
                        "#Java is indeed awesome."),
                new UserAction(5, "Eve", EnumActionType.LIKE,
                        LocalDate.of(2024, 9, 13),
                        ""),
                new UserAction(4, "Dave", EnumActionType.SHARE,
                        LocalDate.of(2024, 9, 14),
                        ""),
                new UserAction(2, "Bob", EnumActionType.POST,
                        LocalDate.of(2024, 9, 15),
                        "Introducing a new #update to the system."),
                new UserAction(1, "Alice", EnumActionType.SHARE,
                        LocalDate.of(2024, 9, 16),
                        ""),
                new UserAction(5, "Eve", EnumActionType.COMMENT,
                        LocalDate.of(2024, 9, 17),
                        "#update looks great!"),
                new UserAction(3, "Charlie", EnumActionType.LIKE,
                        LocalDate.of(2024, 9, 18),
                        ""),
                new UserAction(4, "Dave", EnumActionType.COMMENT,
                        LocalDate.of(2024, 9, 19),
                        "Really liking the new #feature."),
                new UserAction(2, "Bob", EnumActionType.SHARE,
                ...
                new UserAction(3, "Charlie", EnumActionType.LIKE,
                        ...
                        ""),
                new UserAction(5, "Eve", EnumActionType.SHARE,
