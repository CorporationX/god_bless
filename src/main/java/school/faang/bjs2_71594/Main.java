...
public class Main {
    public static void main(String[] args) {
        ...
        Consumer<Notification> emailConsumer = notification ->
                System.out.println("Email: " + notification.getMessage() + "@meta.com");
        Consumer<Notification> pushConsumer = notification ->
