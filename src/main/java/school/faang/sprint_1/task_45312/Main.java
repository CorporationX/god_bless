...
public class Main {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Преступление и наказание", "Достоевский", 1866);
        Book book2 = new Book("Война и мир", "Толстой", 1865);
        Book book3 = new Book("Гордость и предубеждение", "Джейн Остин", 1813);
