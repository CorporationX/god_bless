...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> top5Hashtags = UserActionAnalyzer.topContent(actions, 5);
        List<String> top3Commenters = UserActionAnalyzer.topUsersByComments(actions, 3);
        Map<ActionType, Double> actionPercentages = UserActionAnalyzer.calculatePercentage(actions);
