    ...
    private static List<UserAction> getActions() {
        return Arrays.asList(
                ...
                new UserAction(2, "Bob", "comment",
                        LocalDate.of(2024, 11, 2), "I totally agree with #newfeature."),
                new UserAction(1, "Alice", "like",
                        LocalDate.of(2024, 11, 3), ""),
                new UserAction(3, "Charlie", "share",
                        LocalDate.of(2024, 11, 4), ""),
                new UserAction(4, "Dave", "post",
                        LocalDate.of(2024, 11, 5), "#Java is awesome!"),
                new UserAction(2, "Bob", "like",
                        LocalDate.of(2024, 11, 6), ""),
                new UserAction(3, "Charlie", "post",
                        LocalDate.of(2024, 11, 7), "Check out this cool #project"),
                new UserAction(1, "Alice", "comment",
                        LocalDate.of(2024, 11, 8), "Thanks for sharing #project!"),
                new UserAction(4, "Dave", "like",
                        LocalDate.of(2024, 11, 9), ""),
                new UserAction(2, "Bob", "comment",
                        LocalDate.of(2024, 11, 10), "#Java is everywhere."),
                new UserAction(5, "Eve", "post",
                        LocalDate.of(2024, 11, 11), "Loving the new #feature release!"),
                new UserAction(3, "Charlie", "comment",
                        LocalDate.of(2024, 11, 12), "#Java is indeed awesome."),
                ...
                new UserAction(5, "Eve", "comment",
                        LocalDate.of(2024, 11, 17), "#update looks great!"),
