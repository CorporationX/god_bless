...
public class Main {
    public static List<UserAction> actions = Arrays.asList(
    ...
    public static void main(String[] args) {
        System.out.println("Top users are: " + UserActionAnalyzer.topUsers(actions));
        UserActionAnalyzer.topHashtags(actions);
//        System.out.println("Top hashtags are: " + UserActionAnalyzer.topHashtags(actions));
    }
}
