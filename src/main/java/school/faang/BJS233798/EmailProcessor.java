package school.faang.BJS233798;
...
public class EmailProcessor {
    public void processEmails(List<Email> emailList, Predicate<Email> filter, Function<Email, String> convert, Consumer<Email> handle) {
       for (Email email : emailList) {
           if (filter.test(email)) {
               String processedBody = convert.apply(email);
