...
public class Main {
    public static void main(String[] args) {
        ...
        spells.addSpellEvent("Защита", "Создает магический барьер");
        spells.addSpellEvent("Чары", "Увеличивает силу удара");

        System.out.println("Все события:");
        for (SpellEvent event : spells.printAllSpellEvents()) {
        ...
        System.out.println("\nСобытия типа 'Чары':");
        for (SpellEvent event : spells.getSpellEventsByType("Чары")) {
            System.out.println(event);
        }
