...
public class Main {
    public static void main(String[] args) {
        ...
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(2, "William", "like", LocalDate.of(2024, 9, 6), ""),
                ...
                new UserAction(2, "Ben", "post", LocalDate.of(2024, 9, 15), "Introducing a new #update to the system."),
                ...
                new UserAction(3, "Anna", "comment", LocalDate.of(2024, 10, 2), "The #update has some great features."),
                ...
                new UserAction(5, "David", "share", LocalDate.of(2024, 10, 17), ""),
                new UserAction(2, "Bob", "post", LocalDate.of(2024, 10, 18), "Can't wait for the next #update"),
                new UserAction(4, "Chris", "share", LocalDate.of(2024, 10, 19), "")
        );
