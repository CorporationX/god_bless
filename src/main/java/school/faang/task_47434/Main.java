...
public class Main {
    public static void main(String[] args) {
        ...
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(2, "William", ActionType.LIKE, LocalDate.of(2024, 9, 6), ""),
                ...
                new UserAction(2, "Ben", ActionType.POST, LocalDate.of(2024, 9, 15), "Introducing a new #update to the system."),
                ...
                new UserAction(3, "Anna", ActionType.COMMENT, LocalDate.of(2024, 10, 2), "The #update has some great features."),
                ...
                new UserAction(3, "Charlie", ActionType.SHARE, LocalDate.of(2024, 10, 7), "Here's my review of the new #update."),
                ...
                new UserAction(5, "David", ActionType.SHARE, LocalDate.of(2024, 10, 17), ""),
                new UserAction(2, "Bob", ActionType.POST, LocalDate.of(2024, 10, 18), "Can't wait for the next #update"),
                new UserAction(4, "Chris", ActionType.SHARE, LocalDate.of(2024, 10, 19), "")
        );
