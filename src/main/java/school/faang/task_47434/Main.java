    ...
    public static void main(String[] args) {
        ...
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(4, "Dave", ActionType.SHARE, LocalDate.of(2024, 9, 14),
                        ""),
                new UserAction(2, "Ben", ActionType.POST, LocalDate.of(2024, 9, 15),
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2024, 12, 22),
                ...
                new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2024, 10, 1),
                        ""),
                new UserAction(3, "Anna", ActionType.COMMENT, LocalDate.of(2024, 10, 2),
                ...
                new UserAction(2, "Bob", ActionType.LIKE, LocalDate.of(2024, 10, 6),
                        ""),
                new UserAction(3, "Charlie", ActionType.SHARE, LocalDate.of(2024, 10, 7),
