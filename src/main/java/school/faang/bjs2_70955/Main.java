...
/**
 * Задача "Анализ активности пользователей в социальной сети"
 */
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(UserActionService.getTopUsers(actions, 4));
        System.out.println(UserActionService.getTopHashtags(actions, 6));
        System.out.println(UserActionService.getTopUsersByCommentsLastMonth(actions));
        System.out.println(UserActionService.getActionTypePercentage(actions));
    }
}
