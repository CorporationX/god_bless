...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Economy fare cost: " + economyTripCost);
        System.out.println("Comfort fare cost: " + comfortTripCost);
        System.out.println("Premium fare cost: " + premiumTripCost);
    }
}
