...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        log.info("{}", UserActionAnalyzer.getTopNActiveUsers(actions, 3));
        log.info("{}", UserActionAnalyzer.getTopNPopularHashtags(actions, 5));
        log.info("{}", UserActionAnalyzer.getTopNCommentersLastMonth(actions, 3));
