...
public class Main {
    ...
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(4, "Dave", ActionType.POST, LocalDate.of(2025, 9, 5),
                        "#Java is awesome!"),
                ...
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 9, 10),
                        "#Java is everywhere."),
                new UserAction(5, "Eve", ActionType.POST, LocalDate.of(2025, 9, 11),
                        "Loving the new #feature release!"),
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 9, 12),
                ...
                new UserAction(5, "Eve", ActionType.COMMENT, LocalDate.of(2025, 9, 17),
                        "#update looks great!"),
                ...
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 9, 25),
                ...
                new UserAction(5, "Eve", ActionType.COMMENT, LocalDate.of(2025, 10, 8),
        ...
        log.info("{}", UserActionAnalyzer.getTopActiveUsers(actions, 3));
        log.info("{}", UserActionAnalyzer.getTopPopularHashtags(actions, 5));
        log.info("{}", UserActionAnalyzer.getTopCommentersLastMonth(actions, 3));
        log.info("{}", UserActionAnalyzer.getActionTypePercentages(actions));
    }
}