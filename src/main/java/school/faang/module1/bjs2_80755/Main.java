...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        log.info("Отсортированные по длине строки: {}",
                ListOperations.sortByLength(strings));
        log.info("Все ли числа чётные? {}",
                ListOperations.allMatchCondition(numbers, n -> n % 2 == 0));
        log.info("Наименьшее число больше 4: {}",
                ListOperations.findMinGreaterThan(numbers, 4));
        log.info("Длины строк: {}",
                ListOperations.mapToLengths(strings));
    }
}