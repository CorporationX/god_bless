...
public class Main {
    ...
    private static void initData() {
        bookingSystem.addRoom(new Room(101, "Single",
                new HashSet<>(Set.of("Wi-Fi", "TV", "Air Conditioning"))));
        bookingSystem.addRoom(new Room(202, "Suite",
                new HashSet<>(Set.of("Wi-Fi", "TV", "Air Conditioning", "Mini-bar", "Balcony"))));
        bookingSystem.addRoom(new Room(303, "Economy",
                new HashSet<>(Set.of("Wi-Fi"))));
        bookingSystem.addRoom(new Room(404, "Family",
                new HashSet<>(Set.of("Wi-Fi", "TV", "Air Conditioning", "Mini-kitchen", "Crib"))));
        bookingSystem.addRoom(new Room(505, "Accessible",
                new HashSet<>(Set.of("Wi-Fi", "TV", "Air Conditioning", "Wide doors", "Disability accessories"))));
    }
