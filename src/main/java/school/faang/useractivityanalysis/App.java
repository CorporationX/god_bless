...
public class App {
    ...
    public static void main(String[] args) {
        List<String> top10Users = UserActionAnalyzer.topActiveUsers(ACTIONS, TEN_USERS);
        List<String> top5Hashtags = UserActionAnalyzer.topPopularHashtags(ACTIONS, FIVE_USERS);
        List<String> top3Commenters = UserActionAnalyzer.topCommentersLastMonth(ACTIONS, THREE_USERS);
