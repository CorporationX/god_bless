 ...
 *
 * Ключевая идея: общий жадный подбор навыков вынесен в утилиту SkillCover.assign(...),
 * в которую стратегия передаёт свою функцию скоринга.
 * Balanced снижает score за высокую нагрузку, используя формулу score = gain / (1 + α * load),
 * плюс опциональный «жёсткий потолок» по нагрузке.
 */
