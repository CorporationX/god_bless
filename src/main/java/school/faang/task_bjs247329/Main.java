...
public class Main {
    public static void main(String[] args) {
        ...
        List<Integer> topUsers = UserActionMethods.topActiveUsers(actions);
        List<String> topHashtags = UserActionMethods.topPopularHashtags(actions);
        List<String> topCommenters = UserActionMethods.topCommentersLastMonth(actions);
        Map<String, Double> actionPercentages = UserActionMethods.actionTypePercentages(actions);
