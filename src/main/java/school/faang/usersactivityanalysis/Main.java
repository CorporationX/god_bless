...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = database();
        int top = 5;
        UserActionAnalyzer analyzer = new UserActionAnalyzer();
        System.out.println(analyzer.findTopActiveUsers(actions, top));
        System.out.println(analyzer.findTopPopularContent(actions, top));
        System.out.println(analyzer.findMaxUsersWithComment(actions, top));
        System.out.println(analyzer.actionTypePercentages(actions));


    }

    public static List<UserAction> database() {
