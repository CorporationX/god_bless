...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(topActiveUsers(actions));
        System.out.println(topPopularHashtags(actions));
        System.out.println(topCommentersLastMonth(actions));
        System.out.print(actionTypePercentages(actions));
    }
    ...
    public static List<String> topCommentersLastMonth(List<UserAction> actions) {
        return actions.stream()
                .filter(action -> !StringUtils.isBlank(action.content()) && action.actionType().equals("comment"))
                .collect(Collectors.groupingBy(UserAction::name, Collectors.counting()))
                .entrySet().stream()
                .sorted((o1, o2) -> Long.compare(o1.getValue(), o2.getValue()))
                .limit(3)
