...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = initData();
        ...
        log.info("Top 10 active users: {}", top10Users);
        log.info("Top 5 popular hashtags: {}", top5Hashtags);
        log.info("Top 3 commentators in the last month: {}", top3Commenters);
        log.info("Percentage of actions by type: {}", actionPercentages);
    }

    private static List<UserAction> initData() {
