...
public class Main {
    public static void main(String[] args) {
        ...
        listOfUsers.add(new User("Ivan", 19, "Yandex", "123 Red Square, Moscow, 101000, Russia"));
        listOfUsers.add(new User("Dmitry", 38, "Sber", "45 Nevsky Prospekt, Saint Petersburg, 191011, Russia"));
