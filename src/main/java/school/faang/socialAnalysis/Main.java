package school.faang.socialAnalysis;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(UserActionAnalyser.findTopTenActiveUsers(actions));
        System.out.println(UserActionAnalyser.findTopFiveTopics(actions));
        System.out.println(UserActionAnalyser.findTopThreeUsersByComments(actions));
        System.out.println(UserActionAnalyser.calculateActionsPercentages(actions));
    }
}
