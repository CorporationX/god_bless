...
public class TestFunctionality {
    public static void test() {
        ...
        Notification emailNotification = new Notification(Enums.NotificationType.EMAIL,
                "Ваша учетная запись успешно активирована");
        Notification smsNotification = new Notification(Enums.NotificationType.SMS,
                "Вы успешно изменили свой пароль");
        Notification pushNotification = new Notification(Enums.NotificationType.PUSH,
