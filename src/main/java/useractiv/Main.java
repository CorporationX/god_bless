...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                new UserAction(1, "Alice", ActionType.fromString("post"),
                        LocalDate.of(2024, 9, 1), "Check out this amazing #newfeature!"),
                new UserAction(2, "Bob", ActionType.fromString("comment"),
                        LocalDate.of(2024, 9, 2), "I totally agree with #newfeature."),
                new UserAction(1, "Alice", ActionType.fromString("like"),
                        LocalDate.of(2024, 9, 3), ""),
                new UserAction(3, "Charlie", ActionType.fromString("share"),
                        LocalDate.of(2024, 9, 4), ""),
                new UserAction(4, "Dave", ActionType.fromString("post"),
                        LocalDate.of(2024, 9, 5), "#Java is awesome!"),
                new UserAction(2, "Bob", ActionType.fromString("like"),
                        LocalDate.of(2024, 9, 6), ""),
                new UserAction(3, "Charlie", ActionType.fromString("post"),
                        LocalDate.of(2024, 9, 7), "Check out this cool #project"),
                new UserAction(1, "Alice", ActionType.fromString("comment"),
                        LocalDate.of(2024, 9, 8), "Thanks for sharing #project!"),
                new UserAction(4, "Dave", ActionType.fromString("like"),
                        LocalDate.of(2024, 9, 9), ""),
                new UserAction(2, "Bob", ActionType.fromString("comment"),
                        LocalDate.of(2024, 9, 10), "#Java is everywhere."),
                new UserAction(5, "Eve", ActionType.fromString("post"),
                        LocalDate.of(2024, 9, 11), "Loving the new #feature release!"),
                new UserAction(3, "Charlie", ActionType.fromString("comment"),
                        LocalDate.of(2024, 9, 12), "#Java is indeed awesome."),
                new UserAction(5, "Eve", ActionType.fromString("like"),
                        LocalDate.of(2024, 9, 13), ""),
                new UserAction(4, "Dave", ActionType.fromString("share"),
                        LocalDate.of(2024, 9, 14), ""),
                new UserAction(2, "Bob", ActionType.fromString("post"),
                        LocalDate.of(2024, 9, 15), "Introducing a new #update to the system."),
                new UserAction(1, "Alice", ActionType.fromString("share"),
                        LocalDate.of(2024, 9, 16), ""),
                new UserAction(5, "Eve", ActionType.fromString("comment"),
                        LocalDate.of(2024, 9, 17), "#update looks great!"),
                new UserAction(3, "Charlie", ActionType.fromString("like"),
                        LocalDate.of(2024, 9, 18), ""),
                new UserAction(4, "Dave", ActionType.fromString("comment"),
                        LocalDate.of(2024, 9, 19), "Really liking the new #feature."),
                new UserAction(2, "Bob", ActionType.fromString("share"),
                ...
                new UserAction(5, "Eve", ActionType.fromString("share"),
