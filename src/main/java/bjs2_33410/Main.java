...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> topUsers = UserActionAnalyzer.findMostActiveUsers(actions);
        List<String> topHashtags = UserActionAnalyzer.findHotTopics(actions);
        List<Integer> topCommenters = UserActionAnalyzer.mostActiveUsers(actions);
        Map<String, Double> actionPercentages = UserActionAnalyzer.computeActionPercentages(actions);
