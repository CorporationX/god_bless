...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Максимум: " + ListOperation.maxOfNumbers(numbers));
        ...
        System.out.println("Строки, содержащие 'an': " + ListOperation.filterBySubstring(strings, "an"));
        ...
        System.out.println("Длины строк: " + ListOperation.mapToLengths(strings));
    }
}
