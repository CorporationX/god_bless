...
public class Main {
    private static List<UserAction> actions = Arrays.asList(
            new UserAction(1, "Alice", "post", LocalDate.of(2024, 9, 1), "Check out this amazing #newfeature #newfeature!"),
    ...
    public static void main(String[] args) {
        System.out.println(UserActionAnalyzer.getTenMoreActiveUsersName(actions));
        System.out.println(UserActionAnalyzer.getTopFivePopularHashTags(actions));
        System.out.println(UserActionAnalyzer.getTopThreeCommentersOfTheMonth(actions));
        System.out.println(UserActionAnalyzer.getActionTypePercentages(actions));
    }
}
