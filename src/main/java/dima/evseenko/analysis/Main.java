...
public class Main {
    public static void main(String[] args) {
        System.out.printf("Top 10 %n%s%n", UserActionAnalyzer.topActiveUsers(getUserActions()));
        System.out.printf("Top 5 hashtags %n%s%n", UserActionAnalyzer.topPopularHashtags(getUserActions()));
        System.out.printf("Top 3 commenters last month %n%s%n", UserActionAnalyzer.topCommentersLastMonth(getUserActions()));
        System.out.printf("Action percentage %n%s%n", UserActionAnalyzer.actionPercentages(getUserActions()));
    }
