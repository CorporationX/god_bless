...
public class DictionaryProcessor {
    public void processWord(String word, String translationWord, BiConsumer<String, String> biConsumer) {
        biConsumer.accept(word, translationWord);
