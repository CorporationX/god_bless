...
public class Main {
    public static void main(String[] args) {
        List<UserAction> actions = Arrays.asList(
                new UserAction(1, "Alice", ActionType.POST, LocalDate.of(2025, 3, 29).atStartOfDay(), "Check out this amazing #newfeature!"),
                ...
                new UserAction(2, "Bob", ActionType.SHARE, LocalDate.of(2025, 2, 20).atStartOfDay(), ""),
                ...
                new UserAction(2, "Bob", ActionType.COMMENT, LocalDate.of(2025, 2, 25).atStartOfDay(), "#conference was a blast!"),
                ...
                new UserAction(5, "Eve", ActionType.COMMENT, LocalDate.of(2025, 3, 8).atStartOfDay(), "Your #review was helpful!"),
                ...
                new UserAction(3, "Charlie", ActionType.COMMENT, LocalDate.of(2025, 3, 11).atStartOfDay(), "Sharing my thoughts on the #update."),
