...
public class Main {
    public static void main(String[] args) {
        ...
        List<UserAction> actions = Arrays.asList(
                ...
                new UserAction(2, "Bob", "comment", LocalDate.of(2024, 12, 10), "#Java is everywhere."),
                ...
                new UserAction(2, "Bob", "like", LocalDate.of(2024, 12, 6), ""),
                new UserAction(2, "Bob", "like", LocalDate.of(2024, 10, 6), ""),
                new UserAction(4, "Dave", "comment", LocalDate.of(2024, 12, 14), "#java works really well."),
                new UserAction(4, "Dave", "comment", LocalDate.of(2024, 12, 14), "#update works really well."),
                new UserAction(4, "Dave", "comment", LocalDate.of(2024, 12, 14), "#update works really well."),
                new UserAction(1, "Alice", "comment", LocalDate.of(2024, 12, 30), "Excited to try out the new #update!"),
                new UserAction(1, "Alice", "comment", LocalDate.of(2024, 12, 30), "Excited to try out the new #update!"),
                new UserAction(1, "Alice", "comment", LocalDate.of(2024, 12, 30), "Excited to try out the new #update!"),
        ...
        System.out.println(userService.handlerBestUsers(actions));
        System.out.println(userService.handlerBestMessage(actions));
        System.out.println(userService.SearchBestCommentators(actions));
        userService.calculatorActivityPopularity(actions);
    }
}
