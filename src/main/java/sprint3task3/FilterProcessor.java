...
public class FilterProcessor {
    ...
    public Image applyFilter(Image photo, Function<Image, Image> function) {
        //возвращает новый объект типа Image с применённым фильтром
        //применение сразу скомбинированных двух фильтров??
        //фильтр - это лямбда!
        Image filteredPhoto = new Image();
        Function<Image, Image> filter = filteredPhoto;
        filter.apply(filteredPhoto);
