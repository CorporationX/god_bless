...
3. Создайте ветку с названием `ваш_ник_в_дискорде`. **ВАЖНО: не используйте в названии ветке символы вертикальных разделителей | и слеши \/**. Это будет ваша ветка на весь модуль. Все изменения вы будете коммитить в нее. После создания ветки, запушьте ее на GitHub. ctrl + shift + k в IDEA. Теперь она доступна удаленно.
